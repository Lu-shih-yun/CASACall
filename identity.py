...
M,I,D,X,identity = identity_calculater().identity_eqx('CASACall_Ecoli_test.paf')

print("M I D X = ",M,I,D,X)
print("Insertion error = ",(I/(M+I+D+X))*100)
print("Deletion error = ",(D/(M+I+D+X))*100)
print("Mismatch_error = ",(X/(M+I+D+X))*100)
print("Read Identity = ",identity*100)
